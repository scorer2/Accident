...
import com.example.score_000.parselogintutorial.adapter.NavDrawerListAdapter;
import com.example.score_000.parselogintutorial.model.NavDrawerItem;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String number = null;
        try {
            number = new RecentReportsFragment().getCount();
        ...
        // Recent Reports
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[1], navMenuIcons.getResourceId(1, -1), true, number));
        // Submit Report
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[2], navMenuIcons.getResourceId(2, -1)));
        // Contact Us, Will add a counter here
